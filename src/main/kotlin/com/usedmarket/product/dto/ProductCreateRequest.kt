...
data class ProductCreateRequest(
    ...
    /**
     * Temporary direct stock field for Phase 4. The dedicated Inventory
     * ledger (Phase 6) will become the authoritative source; until then
     * STAFF/ADMIN set stock directly here.
     */
